...
def get_common_params(cl_method: str, seed: int, ella_variant: str = "ella") -> Dict[str, str]:
...
def main():
    ...
    parser.add_argument("--ella_variant", type=str, default="ella", choices=["ella", "ella_with_base_w"],
                        help="ELLA loss variant: 'ella' (W_past) or 'ella_with_base_w' (base model W)")
    ...
    common_params = get_common_params(args.cl_method, args.seed, args.ella_variant)
